	...
	<div class="container">
		<div class="contact-main">
			...
			<div class="contact-block1">
			 	...
			 	<ul>
		 <li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span><p>Above Shree Krishna Hotel, Near Azara Urban Bank, Patgaon Road Gargoti
</p></li> 
				 <li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>+919763877757
</p></li> 
			 <li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:arpit73891@gmail.com">pravin.rajigare@gmail.com </a></p></li></center>
			    </ul>
			 	</div>
